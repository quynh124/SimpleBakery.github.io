<%-- 
    Document   : blog
    Created on : Jul 13, 2024, 10:38:19 PM
    Author     : Hp
--%>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="blog__item">
                            ...
                            <div class="blog__item__pic set-bg" style="background-image: url('./assets/img/blog/blog-1.jpg');">
                    ...
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg" style="background-image: url('./assets/img/blog/blog-2.jpg');">
                            <div class="blog__pic__inner">
                                <div class="label">Recipes</div>
                                <ul>
                                    <li>By <span>James Myers</span></li>
                    ...
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg" style="background-image: url('./assets/img/blog/blog-3.jpg');">
                            <div class="blog__pic__inner">
                                <div class="label">Recipes</div>
                                <ul>
                                    <li>By <span>James Myers</span></li>
                    ...
                    <div class="blog__item">
                        <div class="blog__item__pic" style="background-image: url('./assets/img/blog/blog-4.jpg');">
                            <div class="blog__pic__inner">
                                <div class="label">Recipes</div>
                                <ul>
                                    <li>By <span>James Myers</span></li>
